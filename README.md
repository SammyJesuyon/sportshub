...
2. **Sports browsing (current):** quota-aware, persistently cached matchday fixtures with local pagination and fixture details; public team exploration and authenticated team selection are separate journeys. Standings, team pages, and statistics follow next.
