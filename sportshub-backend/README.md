...
- administrator-only API allowance telemetry, status-aware persistent caching, local match pagination, and cached fixture details with statistics, lineups, and timeline events;
